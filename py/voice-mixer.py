...
try:
    ...
    print("Error: helper.py not found. Please place it in the same directory.")
    sys.exit(1)
...
class LatentExplorerDSP(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.btn_save.setStyleSheet("background-color: #e1f5fe; font-weight: bold;")
        self.btn_save.clicked.connect(self.save_voice_json)
        self.btn_save.setEnabled(False)
        self.btn_reset = QPushButton("Reset to Original")
        self.btn_reset.setStyleSheet("background-color: #ffcccb; font-weight: bold;")
        ...
        self.lbl_lib_status.setStyleSheet("color: gray;")
        
        self.btn_remix = QPushButton("Remix Library")
        self.btn_remix.setToolTip("Mix loaded voices with random weights (Sum=1)")
        self.btn_remix.setStyleSheet("background-color: #d1c4e9; font-weight: bold;")
        ...
        btn_rnd_shift.setStyleSheet("color: #6a1b9a; font-weight: bold;")
        ...
        btn_sharpen.setStyleSheet("color: #d32f2f; font-weight: bold;")
        ...
        btn_trem.setStyleSheet("color: #d32f2f; font-weight: bold;")
        ...
        btn_jit.setStyleSheet("color: #d32f2f; font-weight: bold;")
        ...
        self.lbl_stats.setStyleSheet("font-family: monospace; font-weight: bold; color: blue;")
        ...
        self.btn_generate.setStyleSheet("font-size: 14pt; font-weight: bold; background-color: #4CAF50; color: white;")
    ...
    def load_voice_library(self):
        ...
        try:
            ...
            self.lbl_lib_status.setStyleSheet("color: green; font-weight: bold;")
    ...
    def remix_voices(self):
        ...
        raw_weights = np.random.rand(count)
